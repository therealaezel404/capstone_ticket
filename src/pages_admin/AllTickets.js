      ...
      <Container>
        ...
        <Row>
          <div className="page-content">
            <Link to="../pages_admin/alltickets/all-open-tickets">
            ...
            <Link to="../pages_admin/alltickets/all-reopened-tickets">
              <div className="orange-box">
            ...
            <Link to="../pages_admin/alltickets/all-resolved-tickets">
              <div className="orange-box">
            ...
            <Link to="../pages_admin/alltickets/all-overdue-tickets">
              <div className="orange-box">
            ...
            <Link to="../pages_admin/alltickets/all-voided-tickets">
              <div className="orange-box">
                <div className="orange-box-number">5</div>
