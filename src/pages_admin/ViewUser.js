          ...
          <div className="page-content">
            <center>
              <div className="account-dash">
                <div className="sla">
                  <div className="tix-card-title">SLA COMPLIANCE RATE</div>
                  <div className="tix-card-number">78.7%</div>
                </div>
                <div className="tix">
                  <div className="tix-card">
                    <div className="tix-card-title">OPEN</div>
                    <div className="tix-card-number">4</div>
                  </div>

                  <div className="tix-card">
                    <div className="tix-card-title">RESOLVED</div>
                    <div className="tix-card-number">26</div>
                  </div>

                  <div className="tix-card">
                    <div className="tix-card-title">VOIDED</div>
                    <div className="tix-card-number">4</div>
                  </div>

                  <div className="tix-card">
                    <div className="tix-card-title">OVERDUE</div>
                    <div className="tix-card-number">2</div>
                  </div>
                </div>
              </div>
            </center>
            ...
            <div className="footnote">
              Account Creation Date: 2022-05-11 11:11:11
            </div>
          </div>
        </Row>
      </Container>
