...
const TicketSubmitted = () => {
  return (
    <div>
      <Container fluid className="banner">
        ...
        <Row>
          ...
          >
            <Container>
              <Row>
                <Col className="banner-text-left">TICKET SUBMITTED</Col>
              </Row>
              <Row>
      ...
      <CardWrapper>
        <Card>
          <Headtext> TICKET SUBMITTED! </Headtext>
          <Text1>
            You have successfully submitted a ticket, which our technicians will
            attend to soon.
          </Text1>
          <Text2>
            Wait for your ticket to get verified. You will receive a
            verification email along with a Ticket Reference Code (TRC) which
            you can use to check the status of your ticket. It also signals the
            start of the processing of your request/requests.
          </Text2>
          <Text3>
